...
\documentclass[$if(classoption)$$mode$,longtable,$for(classoption)$$classoption$$sep$,$endfor$$else$$mode$,longtable$endif$$if(floatsintext)$,floatsintext$endif$]{$documentclass$}
